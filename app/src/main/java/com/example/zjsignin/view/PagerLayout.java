...
public class PagerLayout extends LinearLayout {
     ...
     * @param layoutId
     */
    public void setLayout(Context context, int layoutId,String img,onHidden onHidden) {
    ...
    public onHidden onHidden = null;

    public PagerLayout.onHidden getOnHidden() {
        return onHidden;
    }

    public void setOnHidden(PagerLayout.onHidden onHidden) {
        this.onHidden = onHidden;
    }
