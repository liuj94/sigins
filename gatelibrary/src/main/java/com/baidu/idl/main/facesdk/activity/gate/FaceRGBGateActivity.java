...
//    private static final int PERFER_HEIGH = SingleBaseConfig.getBaseConfig().getRgbAndNirHeight();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("SingleBaseConfig","SingleBaseConfig.getBaseConfig().getRgbVideoDirection()="+SingleBaseConfig.getBaseConfig().getRgbVideoDirection());
        Log.d("SingleBaseConfig","SingleBaseConfig.getBaseConfig().getRgbVideoDirection()="+SingleBaseConfig.getBaseConfig().getRgbVideoDirection());
    ...
    private void initView() {
        ...
        judgeFirst();
       String contentBase = "";
        Base64.decode(contentBase.getBytes(),Base64.DEFAULT);
    }
...
//        }
        CameraPreviewManager.getInstance().setCameraFacing(CameraPreviewManager.CAMERA_FACING_FRONT);
        Log.d("SingleBaseConfig","mLiveType="+mLiveType);
